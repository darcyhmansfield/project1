...
Team.destroy_all
t1 = Team.create :name => "Jonesy's Phenomenal Fighters", :members => "Rhea Ripley", :total_rating => nil
puts "#{ Team.count } teams"
t2 = Team.create :name => "Davey's Dynastic Dopplers", :members => "Great Muta", :total_rating => nil
